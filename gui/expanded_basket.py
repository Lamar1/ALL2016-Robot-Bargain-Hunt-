...
class ExpandedBasket:
    ...
    def __init__(self, root):
        ...
        def frames(self):
            ...
            self.columnFrame = Frame(self.root, width=225, height = 800, background="lightgrey")
            self.columnFrame.grid(row=2, column=1, padx=0, pady=0, sticky="w")

            self.columnFrame2 = Frame(self.root, width=225, height = 800, background="white")
            self.columnFrame2.place(anchor="c", relx=0.3, rely=0.563)

            self.columnFrame3 = Frame(self.root, width=225, height = 800, background="lightgrey")
            self.columnFrame3.place(anchor="c", relx=0.5, rely=0.563)

            self.columnFrame4 = Frame(self.root, width=225, height = 800, background="white")
            self.columnFrame4.place(anchor="c", relx=0.7, rely=0.563)

            self.columnFrame5 = Frame(self.root, width=225, height = 800, background="lightgrey")
            self.columnFrame5.place(anchor="c", relx=0.9, rely=0.563)
